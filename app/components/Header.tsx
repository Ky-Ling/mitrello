	...
	return (
		<header>
			<div className="flex flex-col md:flex-row items-center p-5 bg-gray-500/10 rounded-b-2xl">
				<div
					className="absolute top-0 left-0 w-full h-96 bg-gradient-to-br from-pink-400 to-[#0055D1] rounded-md filter
        ...
        "
				...
				<div className="flex item-center space-x-5 flex-1 justify-end w-full">
					...
					<Avatar name="Torrid Guo" round size="50" color="#0055D1" />
				</div>
			</div>
